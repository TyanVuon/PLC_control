    ...
    def read_data(self):
        ...
        try:
            ...
            if raw_data:
                ...
                """ # Print the second and third numbers to the terminal
                    if len(words) >= 3:
                        print(f"[INFO] Layer: {words[1] - 1}, Sections: {words[2]}")
                
                # Return only the first number (command) for system control
                print(f"Capture Done: {words[0]}") """
